...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personal site of Adeniji Taiwo Emmanuel (ATE) — Believer, Cybersecurity Analyst, Technology Enthusiast, Leader, and Geomatics Student." },
